 ...
 */
export async function onPageChange (callback = (location: string): void => { console.log(`location changed : ${location} but onPageChange callback is empty`) }, wait = 1000, last = ''): Promise<void> {
  await sleep(wait)
