...
import { browserContext, browserReport, getBrowser, getOperatingSystem, getVersion, isMobile } from '../src'
...
it('isMobile A', () => { expect(isMobile(userAgentA)).toBe(false) })
...
it('isMobile B', () => { expect(isMobile(userAgentB)).toBe(false) })
...
it('isMobile C', () => { expect(isMobile(userAgentC)).toBe(true) })
...
it('isMobile D', () => { expect(isMobile(userAgentD)).toBe(true) })
...
it('isMobile E', () => { expect(isMobile(userAgentE)).toBe(false) })
...
it('isMobile F', () => { expect(isMobile(userAgentF)).toBe(false) })
...
it('isMobile G', () => { expect(isMobile(userAgentG)).toBe(false) })
...
it('isMobile H', () => { expect(isMobile(userAgentH)).toBe(false) })
...
it('isMobile I', () => { expect(isMobile(userAgentI)).toBe(false) })
...
it('isMobile J', () => { expect(isMobile(userAgentJ)).toBe(false) })
